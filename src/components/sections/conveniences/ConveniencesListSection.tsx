...
export default function ConveniencesListSection({
  data,
  isPending,
  refresh,
}: ConveniencesListSectionProps) {
  ...
  const deleteConvenienceMutation = useMutation({
    mutationFn: deleteSpaceConvenience,
    onSuccess: () => {
      toast({
        variant: 'success',
        title: t('success'),
        ...
        <DataTable.HeaderActionsContainer className="pl-4">
          <div className="w-full flex items-center gap-3">
            ...
            <Button
              ...
              onClick={() => router.push('/reference-data/conveniences/create')}
            >
              {t('table.create')}
            </Button>
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          <DialogFooter>
            ...
            <Button
              color="destructive"
              onClick={() => {
                deleteConvenienceMutation.mutate({
